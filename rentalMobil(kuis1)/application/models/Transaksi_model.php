...
class transaksi_model extends CI_Model{
    ...
    public function get_data_transaksi(){
        $this->db->select('transaksi.id_transaksi, user.nama, mobil.merk, transaksi.tanggal_sewa, transaksi.tanggal_kembali, transaksi.total_sewa, transaksi.status');
    ...
    public function get_data_type(){
        $this->db->select('transaksi.id_transaksi, transaksi.id_type, transaksi.total_sewa, transaksi.id_type, transaksi.merk, transaksi.no_plat, transaksi.warna, transaksi.tahun, transaksi.status, transaksi.gambar, type.id_type, type.kode_type, type.nama_type');
        $this->db->from('transaksi');
